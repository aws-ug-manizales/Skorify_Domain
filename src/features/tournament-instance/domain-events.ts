...
export const GottenTournamentInstanceCurrentRankingDomainEvent =
  DomainEventKind<RankingItem[]>(
    "GottenTournamentInstanceCurrentRankingDomainEvent",
  );

export const NotGottenTournamentInstanceCurrentRankingDomainEvent =
  DomainEventKind("NotGottenTournamentInstanceCurrentRankingDomainEvent");
...
export const TournamentInstanceSavedDomainEvent =
  DomainEventKind<TournamentInstanceEntity>(
...
export const GottenTournamentInstanceDomainEvent =
  DomainEventKind<TournamentInstanceEntity>(
    "GottenTournamentInstanceDomainEvent",
  );
export const CalculatedRankingDomainEvent = DomainEventKind(
